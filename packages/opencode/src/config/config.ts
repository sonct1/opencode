  ...
  export const Info = z
    .object({
      ...
      autoupdate: z
        ...
        .optional()
        .describe(
          "Automatically update to the latest version. Set to true to auto-update, false or 'notify' to disable auto-update, or 'notify' to show update notifications only",
        ),
